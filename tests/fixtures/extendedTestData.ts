...
export const EXTENDED_TEST_NODES: {
  ...
  edgeCases: [
    {
      title: 'Very Long Title That Exceeds Normal Length Expectations And Tests System Limits For Title Processing And Display',
    ...
    {
      title: 'Whitespace\\nNewlines\\tTabs Test',
      content: 'Content with various whitespace:\n\n- Line breaks\n\t- Tabs\n   - Spaces\n\r\n- Windows line endings',
      file_type: 'md',
    },
    {
      title: 'Large Content Test',
      content: 'Large content: ' + 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. '.repeat(100),
      file_type: 'md',
    },
    {
  ...
  metadata: [
    {
      ...
      aliases: ['Complex Meta', 'Metadata Test', 'メタデータテスト', 'Тест метаданных'],
      refs: [
