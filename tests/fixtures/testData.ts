...
export const TEST_NODES: {
  ...
  markdown: [
    ...
    {
      title: 'Japanese Markdown Note',
      content: '# 日本語テスト\n\nこれは日本語のマークダウンノートです。\n\n- リスト項目1\n- リスト項目2',
      tags: ['日本語', 'テスト', 'markdown'],
      aliases: ['Japanese Test', '日本語ノート'],
      category: 'japanese',
      file_type: 'md',
    },
  ],
...
export function generateBulkTestData(count: number, fileType: 'md' | 'org' = 'md'): CreateNodePayload[] {
...
export function createTestDataVariations(baseData: CreateNodePayload): CreateNodePayload[] {
  return [
    // Base data
    { ...baseData },
