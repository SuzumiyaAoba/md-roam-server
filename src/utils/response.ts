...
export function successResponse<T>(c: Context, message: string, data?: T, status = 200): Response {
...
export function errorResponse(c: Context, message: string, error?: string, status = 400): Response {
